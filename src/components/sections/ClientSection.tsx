...
import { Box, Text, Stack, Image, Heading } from "@chakra-ui/react";
...
const feedbacks = [
    {
        ...
        left: { base: "auto", md: "30%", lg: "30%" },
        top: { base: "auto", md: "2%", lg: "2%" },
    ...
    },
    {
        ...
        filter: "drop-shadow(15px -6px 0px rgba(100, 100, 100, 0.6))",
        outline: "1.5px solid #080427",
        left: { base: "auto", md: "32%", lg: "32%" },
        top: { base: "auto", md: "18%", lg: "18%" },
        position: { base: "relative", md: "absolute" },
    },
    {
        username: "Username",
        ...
        filter: "drop-shadow(-15px 6px 0px rgba(100, 100, 100, 0.6))",
        outline: "1.5px solid #080427",
        left: { base: "auto", md: "27%", lg: "29%" },
        top: { base: "auto", md: "33%", lg: "34%" },
        position: { base: "relative", md: "absolute" },
    },
    {
        username: "Username",
        ...
        filter: "drop-shadow(15px -6px 0px rgba(100, 100, 100, 0.6))",
        outline: "1.5px solid #080427",
        right: { base: "auto", md: "27%", lg: "25%" },
        top: { base: "auto", md: "48%", lg: "50%" },
        position: { base: "relative", md: "absolute" },
    },
    {
        username: "Username",
        ...
        filter: "drop-shadow(15px 6px 0px rgba(100, 100, 100, 0.6))",
        outline: "1.5px solid #080427",
        right: { base: "auto", md: "30%", lg: "31%" },
        bottom: { base: "auto", md: "20%", lg: "19%" },
        position: { base: "relative", md: "absolute" },
    },
];
    ...
    return (
        <Box position="relative" py={{ base: 12, md: 20, lg: 20 }} overflow="hidden">
            ...
            <Box textAlign="center" mb={{ base: 10, md: 32, lg: 32 }} zIndex={1} position="relative">
                <Heading
                    fontSize={{ base: "3xl", sm: "4xl", md: "6xl", lg: "100px" }}
                ...
                <Text
                    ...
                    py={1}
                    right={{ base: "20%", sm: "25%", md: "35%", lg: "35%" }}
                    rotate="-6deg"
            ...
            <Image
                ...
                alt="StarBlue"
                position="absolute"
                top={{ base: "20%", sm: "18%", md: "20%", lg: "20%" }}
                right={{ base: "27%", sm: "25%", md: "27%", lg: "27%" }}
                w={{ base: "50px", sm: "55px", md: "60px", lg: "50px" }}
                rotate="20deg"
                zIndex={3}
            />
            <Image
                ...
                alt="StarPurple"
                position="absolute"
                top={{ base: "25%", sm: "23%", md: "25%", lg: "26%" }}
                left={{ base: "24%", sm: "22%", md: "24%", lg: "23%" }}
                w={{ base: "30px", sm: "35px", md: "40px", lg: "30px" }}
                rotate="-20deg"
                zIndex={3}
            />
            <Image
                ...
                alt="Quote"
                position="absolute"
                top={{ base: "39%", sm: "37%", md: "39%", lg: "37%" }}
                left={{ base: "28%", sm: "26%", md: "28%", lg: "28%" }}
                w={{ base: "80px", sm: "90px", md: "100px", lg: "80px" }}
                zIndex={3}
            />
            <Image
                ...
                alt="StarBase"
                position="absolute"
                top={{ base: "47%", sm: "45%", md: "47%", lg: "46%" }}
                right={{ base: "28%", sm: "26%", md: "28%", lg: "27%" }}
                w={{ base: "80px", sm: "90px", md: "100px", lg: "80px" }}
                zIndex={3}
            />
            <Image
                ...
                alt="StarRed"
                position="absolute"
                bottom={{ base: "35%", sm: "33%", md: "35%", lg: "36%" }}
                left={{ base: "27%", sm: "25%", md: "27%", lg: "28%" }}
                w={{ base: "50px", sm: "55px", md: "60px", lg: "50px" }}
                zIndex={3}
            />
            <Image
                ...
                alt="Quote2"
                position="absolute"
                bottom={{ base: "26%", sm: "24%", md: "26%", lg: "25%" }}
                right={{ base: "25%", sm: "23%", md: "25%", lg: "26%" }}
                w={{ base: "80px", sm: "90px", md: "100px", lg: "80px" }}
                zIndex={3}
                transform={"scaleX(-1)"}
            />
